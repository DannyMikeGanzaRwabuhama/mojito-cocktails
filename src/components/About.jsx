    ...
    useGSAP(() => {
        ...
        scrollTimeline
            .from(titleSplit.words, {
                opacity: 0, duration: 2, yPercent: 100, ease: 'expo.out', stagger: 0.02
            })
